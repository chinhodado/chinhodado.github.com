...
var Card = (function () {
    ...
    Card.prototype.getPassiveDamageEffect = function (target) {
        ...
        if (passiveSkill && passiveSkill.skillFunc === 1001 /* DAMAGE_PASSIVE */) {
    ...
    Card.prototype.getPassiveReceivedDamageEffect = function (attacker) {
        var passiveSkill = this.passiveSkills[0];
        if (passiveSkill && passiveSkill.skillFunc === 1002 /* DEFENSE_PASSIVE */) {
...
var famDatabase = {
    ...
    11601: {
        name: "Brine",
        stats: [18501, 6898, 16009, 22000, 17591],
        skills: [900, 901],
        autoAttack: 10121,
        img: "217",
        rarity: 5,
